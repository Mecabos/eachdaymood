package com.bacemprog.eachdaymood.util;


import com.bacemprog.eachdaymood.enumeration.DurationType;
...
public class DateUtil {
    ...
    public static final String FORMAT_DEFAULT = "dd-MM-yyyy HH:mm";
    ...
    public static LocalDateTime getCurrentDateTimeWithOffset(String offset) {
        ZoneId zoneId = ZoneId.of(TIME_ZONE_DEFAULT);
        if (offset.equals("")){
            System.err.println("Offset given empty ! returning date without offset");
        }else{
